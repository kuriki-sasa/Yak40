...
-   [はじめに](#orgb00de37)
-   [1. 準備](#org771bef2)
    -   [1.1. パーツ・工具の確認](#org46a04d6)
        -   [1.1.1 キットに含まれるパーツ・工具](#orgbbbce1a)
        -   [1.1.2. ご自身でご用意いただくパーツ・工具](#orgdb7027d)
    -   [1.2. PCBの動作確認](#orga627668)
        -   [1.2.1. Vial環境の準備](#org8c527ce)
        -   [1.2.2. ファームウェア書き込み](#org0d89a7f)
        -   [1.2.3. Vialを起動](#org46bd9ed)
-   [2. 組み立て](#org84ae81a)
    -   [2.1. レイアウトの選択](#org2483b17)
        -   [2.1.1. スタビライザーの取り付け](#org08148a1)
        -   [2.1.2. ロータリーエンコーダーの取り付け](#org6cd393a)
    -   [2.2. スイッチプレート取り付け](#orge2e23e5)
    -   [2.3. PCB取り付け](#org3a56d6f)
    -   [2.4. ドーターボード取り付け](#orgdcdadc0)
    -   [2.5. 動作確認](#orgcfa3f19)
    -   [2.6. キーキャップ取り付け](#org55f6e85)
-   [3. キーマップの設定](#orgbed0f8d)
-   [4. メンテナンス](#orgd91b491)
    -   [4.1. ファームウェア更新](#org37db08a)
-   [5. トラブルシューティング](#org62471d4)
    -   [5.1. キーボードを認識しない](#org5b61450)
    -   [5.2. キースイッチが反応しない](#orgdc73b13)
    -   [5.3. ロータリーエンコーダーが反応しない](#org60d291b)
-   [6. 連絡先](#org7ff09a3)
-   [さいごに](#orge9f6e86)
...
不足がある場合は[6. 連絡先](#org7ff09a3)までご連絡ください。
...
認識しない場合はは[5. トラブルシューティング](#org62471d4)をご確認ください。  
...
6.  表示された二箇所のキーを長押しする
    ...
    -   キーを押しているのに進捗バーが進まない場合、キーが反応していない可能性があります。  
        [5. トラブルシューティング](#org62471d4)をご確認ください。
7.  全キーが反応することを確認する
    ![img](./images/test_matrix.png)
    -   反応しないキーがある場合は[5. トラブルシューティング](#org62471d4)をご確認ください。
