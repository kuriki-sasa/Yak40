...
-   [はじめに](#org5e55c30)
-   [1. 準備](#org83c2980)
    -   [1.1. パーツ・工具の確認](#org24204d9)
        -   [1.1.1 キットに含まれるパーツ・工具](#org504decc)
        -   [1.1.2. ご自身でご用意いただくパーツ・工具](#orgef855a7)
    -   [1.2. PCBの動作確認](#org2a6c58f)
        -   [1.2.1. Vial環境の準備](#org655f0bc)
        -   [1.2.2. ファームウェア書き込み](#org7737d47)
        -   [1.2.3. Vialを起動](#orgd6e5fb6)
-   [2. 組み立て](#org4ba0d0d)
    -   [2.1. レイアウトの選択](#org68a2f2e)
        -   [2.1.1. スタビライザーの取り付け](#org0232c14)
        -   [2.1.2. ロータリーエンコーダーの取り付け](#org8660aa2)
    -   [2.2. スイッチプレート取り付け](#org718fe84)
    -   [2.3. PCB取り付け](#org1d29381)
    -   [2.4. ドーターボード取り付け](#org4f03e8f)
    -   [2.5. 動作確認](#org0468eb0)
    -   [2.6. キーキャップ取り付け](#orgdb681bc)
-   [3. キーマップの設定](#org801762f)
-   [4. メンテナンス](#org9ffdab4)
    -   [4.1. ファームウェア更新](#org0a94e07)
-   [5. トラブルシューティング](#org473b910)
    -   [5.1. キーボードがPCに認識されない](#org2d77bc8)
    -   [5.2. キースイッチが反応しない](#orgd7b928b)
    -   [5.3. ロータリーエンコーダーが反応しない](#org4f0f8a5)
-   [6. 連絡先](#org29c8500)
-   [さいごに](#org59365bc)
...
不足がある場合は[6. 連絡先](#org29c8500)までご連絡ください。
...
認識しない場合はは[5. トラブルシューティング](#org473b910)をご確認ください。  
...
6.  表示された二箇所のキーを長押しする  
    ...
    -   キーを押しているのに進捗バーが進まない場合、キーが反応していない可能性があります。  
        [5. トラブルシューティング](#org473b910)をご確認ください。
7.  全キーが反応することを確認する  
    ![img](./images/test_matrix.png)
    -   反応しないキーがある場合は[5. トラブルシューティング](#org473b910)をご確認ください。
