...
-   [はじめに](#org497ccd1)
-   [1. 準備](#org99efc88)
    -   [1.1. パーツ・工具の確認](#orgae613de)
        -   [1.1.1 キットに含まれるパーツ・工具](#orgded1bda)
        -   [1.1.2. ご自身でご用意いただくパーツ・工具](#orgcd474eb)
    -   [1.2. PCBの動作確認](#org0d24b9e)
        -   [1.2.1. Vial環境の準備](#org9fcac92)
        -   [1.2.2. ファームウェア書き込み](#org32b3ca2)
        -   [1.2.3. Vialを起動](#org4e53d75)
-   [2. 組み立て](#org336019f)
    -   [2.1. レイアウトの選択](#org202d2cd)
        -   [2.1.1. スタビライザーの取り付け](#org588a047)
        -   [2.1.2. ロータリーエンコーダーの取り付け](#org91fb222)
    -   [2.2. スイッチプレート取り付け](#org1070116)
    -   [2.3. PCB取り付け](#org43bfde1)
    -   [2.4. ドーターボード取り付け](#org4d1a2ae)
    -   [2.5. 動作確認](#orga20ddf2)
    -   [2.6. キーキャップ取り付け](#org5c6d57a)
-   [3. キーマップの設定](#org530ebb9)
-   [4. メンテナンス](#org6fa63eb)
    -   [4.1. ファームウェア更新](#org15b1a17)
-   [5. トラブルシューティング](#org00dcb6e)
    -   [5.1. キーボードがPCに認識されない](#org7425e70)
    -   [5.2. キースイッチが反応しない](#org65382fc)
    -   [5.3. ロータリーエンコーダーが反応しない](#orgf9bfbc1)
-   [6. 連絡先](#org3eb5988)
-   [さいごに](#orgdcdefe0)
...
不足がある場合は[6. 連絡先](#org3eb5988)までご連絡ください。
...
認識しない場合はは[5. トラブルシューティング](#org00dcb6e)をご確認ください。
...
6.  表示された二箇所のキーを長押しする  
    ...
    -   キーを押しているのに進捗バーが進まない場合、キーが反応していない可能性があります。  
        [5. トラブルシューティング](#org00dcb6e)をご確認ください。
7.  全キーが反応することを確認する  
    ![img](./images/test_matrix.png)
    -   反応しないキーがある場合は[5. トラブルシューティング](#org00dcb6e)をご確認ください。
