...
-   [はじめに](#orgd41707e)
-   [1. 準備](#org9c74e0d)
    -   [1.1. パーツ・工具の確認](#orgcfe3395)
        -   [1.1.1 キットに含まれるパーツ・工具](#org9680a9a)
        -   [1.1.2. ご自身でご用意いただくパーツ・工具](#org1c0b1f2)
    -   [1.2. PCBの動作確認](#org2c43ddc)
        -   [1.2.1. Vial環境の準備](#orged84f79)
        -   [1.2.2. ファームウェア書き込み](#orgb3a0d83)
        -   [1.2.3. Vialを起動](#org10777e8)
-   [2. 組み立て](#org3b7a38c)
    -   [2.1. レイアウトの選択](#org5aa8204)
        -   [2.1.1. スタビライザーの取り付け](#orgcb942d8)
        -   [2.1.2. ロータリーエンコーダーの取り付け](#org5e6a733)
    -   [2.2. スイッチプレート取り付け](#org4470627)
    -   [2.3. PCB取り付け](#org1a69f0e)
    -   [2.4. ドーターボード取り付け](#orgb328854)
    -   [2.5. 動作確認](#org8171be6)
    -   [2.6. キーキャップ取り付け](#org7d78f1d)
-   [3. キーマップの設定](#org3b0c01c)
-   [4. メンテナンス](#org46af5f7)
    -   [4.1. ファームウェア更新](#org1d866db)
-   [5. トラブルシューティング](#org604b5c5)
    -   [5.1. キーボードがPCに認識されない](#org5edd667)
    -   [5.2. キースイッチが反応しない](#orgb2112b4)
    -   [5.3. ロータリーエンコーダーが反応しない](#orgea98710)
-   [6. 連絡先](#org0c13881)
-   [さいごに](#org9a818c5)
...
不足がある場合は[6. 連絡先](#org0c13881)までご連絡ください。
...
認識しない場合はは[5. トラブルシューティング](#org604b5c5)をご確認ください。  
...
6.  表示された二箇所のキーを長押しする
    ...
    -   キーを押しているのに進捗バーが進まない場合、キーが反応していない可能性があります。  
        [5. トラブルシューティング](#org604b5c5)をご確認ください。
7.  全キーが反応することを確認する
    ![img](./images/test_matrix.png)
    -   反応しないキーがある場合は[5. トラブルシューティング](#org604b5c5)をご確認ください。
