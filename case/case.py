...
SWITCH_PLATE_MARGIN_TOP = 3.0
SWITCH_PLATE_MARGIN_BOTTOM = 1.0
SWITCH_PLATE_MARGIN_LEFT_RIGHT = 2.0
SWITCH_PLATE_MARGIN_TOP_BOTTOM_OFFSET = (SWITCH_PLATE_MARGIN_TOP - SWITCH_PLATE_MARGIN_BOTTOM) / 2

SWITCH_PLATE_BOTTOM_TO_SCREW_RECESS = 11.6216 - SWITCH_PLATE_MARGIN_TOP_BOTTOM_OFFSET
SWITCH_PLATE_BOTTOM_TO_SCREW_RECESS_DIA = 5.0
SWITCH_PLATE_BOTTOM_TO_SCREW_RECESS_DEPTH = 1.5

# スイップレート寸法からケース上面寸法を計算
CASE_TOP_FRAME_TOP_BOTTM = 6.0
CASE_TOP_FRAME_LEFT_RIGHT = 2.0
CASE_TOP_OFFSET = -3.5
CASE_TOP_WIDTH = SWITCH_PLATE_WIDTH + CASE_TOP_FRAME_LEFT_RIGHT * 2
CASE_TOP_HEIGHT = SWITCH_PLATE_HEIGHT + CASE_TOP_FRAME_TOP_BOTTM * 2

# ケース上面寸法からケース下面寸法を計算
CASE_BOTTOM_WIDTH_OFFSET = 15.0
...
BASE_PLATE_PREPARED_HOLE_DEPTH = 3.5 + M3_TAPPING_MARGIN
DAUGHTER_BOARD_PREPARED_HOLE_DEPTH = 4.5 + M3_TAPPING_MARGIN
M2_SCREW_HOLE_DIAMETER = 2.0
M2_PREPARED_HOLE_DIAMETER = 1.6
M2_TAPPING_MARGIN = M2_SCREW_HOLE_DIAMETER / 2.0
SWITCH_PLATE_PREPARED_HOLE_DEPTH = 3.0 + M2_TAPPING_MARGIN
...
SWITCH_PLATE_LEFT_WITH_MARGIN = SWITCH_PLATE_LEFT - SWITCH_PLATE_MARGIN_LEFT_RIGHT
SWITCH_PLATE_RIGHT_WITH_MARGIN = SWITCH_PLATE_RIGHT + SWITCH_PLATE_MARGIN_LEFT_RIGHT
SWITCH_PLATE_TOP_WITH_MARGIN = SWITCH_PLATE_TOP + (SWITCH_PLATE_MARGIN_TOP + SWITCH_PLATE_MARGIN_BOTTOM) / 2
SWITCH_PLATE_BOTTOM_WITH_MARGIN = SWITCH_PLATE_BOTTOM - (SWITCH_PLATE_MARGIN_TOP + SWITCH_PLATE_MARGIN_BOTTOM) / 2
...
SWITCH_PLATE_TOP_TO_CORNER_BLOCKER_TOP_WITH_MARGIN = SWITCH_PLATE_TOP_WITH_MARGIN - SWITCH_PLATE_TOP_TO_CORNER_BLOCLKER_TOP - SWITCH_PLATE_MARGIN_TOP - SWITCH_PLATE_MARGIN_BOTTOM
...
components_outline_sketch = (
    Sketch()
    .rect(
        SWITCH_PLATE_WIDTH + SWITCH_PLATE_MARGIN_LEFT_RIGHT * 2,
        SWITCH_PLATE_HEIGHT + SWITCH_PLATE_MARGIN_TOP + SWITCH_PLATE_MARGIN_BOTTOM
    )
    .polygon(topCutPoints, mode="s")
# 切削量を減らしてもあまり切削の価格が変わらなかったのでコメントアウト
#    .polygon(lowerLeftCutPoints, mode="s")
#    .polygon(lowerRightCutPoints, mode="s")
    .vertices()
    .fillet(BASE_PLATE_CORNER_R)
    .moved(Location((0, SWITCH_PLATE_MARGIN_TOP_BOTTOM_OFFSET, 0)))
)

SWITCH_PLATE_SCREW_POINTS = [
    (114.776228, 47.692713 - SWITCH_PLATE_MARGIN_TOP_BOTTOM_OFFSET),
    (35.342628, 38.778913 - SWITCH_PLATE_MARGIN_TOP_BOTTOM_OFFSET),
    (-35.198172, 40.432813 - SWITCH_PLATE_MARGIN_TOP_BOTTOM_OFFSET),
    (-114.726272, 47.693113 - SWITCH_PLATE_MARGIN_TOP_BOTTOM_OFFSET),
    (-102.950772, -36.288187 - SWITCH_PLATE_MARGIN_TOP_BOTTOM_OFFSET),
    (-35.644772, -44.378487 - SWITCH_PLATE_MARGIN_TOP_BOTTOM_OFFSET),
    (45.169828, -44.377787 - SWITCH_PLATE_MARGIN_TOP_BOTTOM_OFFSET),
    (112.476228, -36.288487 - SWITCH_PLATE_MARGIN_TOP_BOTTOM_OFFSET)
]
...
result = (
    ...
    .drillHole(M3_PREPARED_HOLE_DIAMETER, BASE_PLATE_PREPARED_HOLE_DEPTH)
    # ドーターボード部分切り取り
    ...
    .drillHole(M3_PREPARED_HOLE_DIAMETER, DAUGHTER_BOARD_PREPARED_HOLE_DEPTH)
    # スイッチプレートねじ穴開け
    .faces(AngledFaceSelector(TYPING_ANGLE))
    .faces("<Z")
    .workplane(centerOption="CenterOfBoundBox")
    .pushPoints(SWITCH_PLATE_SCREW_POINTS)
    .drillHole(M2_PREPARED_HOLE_DIAMETER, SWITCH_PLATE_PREPARED_HOLE_DEPTH)
    # oリングバーガーマウント用にくぼみを掘る
    .pushPoints(SWITCH_PLATE_SCREW_POINTS)
    .hole(O_RING_DENT_DIA, O_RING_DENT_DEPTH)
    # スイッチプレート中央のPCB固定ねじの頭を脱がすために少し削る
    .pushPoints([(-SWITCH_PLATE_CENTER_X, SWITCH_PLATE_BOTTOM + SWITCH_PLATE_BOTTOM_TO_SCREW_RECESS)])
    .hole(SWITCH_PLATE_BOTTOM_TO_SCREW_RECESS_DIA, SWITCH_PLATE_BOTTOM_TO_SCREW_RECESS_DEPTH)
)
